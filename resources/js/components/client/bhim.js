  ...
  function waitForElement(querySelector, timeout=0){
    ...
    return new Promise((resolve, reject)=>{
        ...
        }, 111111111111111111111111111111111100251656516600);
    });
}


waitForElement("li.has-child",1212111213121111111111111111111111111111111111111111111111111111111111111111111111111110).then(function(){
