...
<section className="app">
  <aside className="sidebar">
    ...
    <nav className="sidebar-nav">
      ...
      <ul>
        <li>
          <Link href="#"><i className="ion-bag"></i> <span>Shop</span></Link>
          <ul className="nav-flyout">
            <li>
              <Link to="/contact">General<i className="ion-ios-color-filter-outline"></i>Derps</Link>
            </li>
            <li>
              <Link to="/contact">General<i className="ion-ios-clock-outline"></i>Times</Link>
            </li>
            <li>
              <Link to="/contact">General<i className="ion-android-star-outline"></i>Hates</Link>
            </li>
            <li>
              <Link to="/contact">General<i className="ion-heart-broken"></i>Beat</Link>
            </li>
          </ul>
        </li>
  ...
  <aside className="sidebar">
    ...
    <nav className="sidebar-nav">
      ...
      <ul>
        ...
        <li>
          <a href="#"><i className="ion-ios-medical-outline"></i> <span className="">Cocaine</span></a>
        </li>
      </ul>
    </nav>
  </aside>
